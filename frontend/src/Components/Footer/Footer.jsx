...
const Footer = () => {
  return (
    <>
      <div className="border-t border-gray-300 bg-black text-white mt-20 py-20 px-16 flex justify-between w-full mx-auto">
        <div className="flex flex-col w-1/3 gap-4 text-gray-200">
          <h1 className="text-4xl text-white font-bold mb-2">LuxSpace</h1>
